...
\subsection{Теорема об общей точке системы вложенных отрезков}

\mcthm{Теорема об общей точке системы вложенных отрезков}{
...
\begin{split}
    ...
    & \text{аналогично } \exists \sup{B} = \beta, B = \{a_n\}_{n \in \mathbb{N}} \\
