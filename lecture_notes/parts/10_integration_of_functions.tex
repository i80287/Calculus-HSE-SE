...
\mcthm{Свойства определённого интеграла}{
\begin{tabular}{rl}
    1.  & Линейность: \\
        ...
        $\\
    2.  & Если $f, g \in R[a; b]$, то $ f, g \in R[a; b] \wedge | f | \in R[a; b] $ \\
...
2-е свойство доказывается аналогично 1-ому доказательству,
т.к. множества точек разрыва функций $f \cdot g$ и $|f|$ меры ноль по Лебегу
и эти функции непрерывны на $[a; b]$
...
\mcthm{Теорема о среднем (для интегралов)}{
