...
\begin{tikzpicture}
    ...
    \filldraw[green!40!black] (0.5,0.6) node[]{$x_{0}$};
    \filldraw[green!40!black] (1.5,0.6) node[]{$x_{1}$};
    \filldraw[green!40!black] (3.5,0.6) node[]{$x_{2}$};
    \filldraw[green!40!black] (5.5,0.6) node[]{$x_{3}$};
    \filldraw[red!40!black] (0.5,-0.5) node[]{$x'_{0}$};
    \filldraw[red!40!black] (1.5,-0.5) node[]{$x'_{1}$};
    \filldraw[red!40!black] (2.5,-0.5) node[]{$x'_{2}$};
    \filldraw[red!40!black] (3.5,-0.5) node[]{$x'_{3}$};
    \filldraw[red!40!black] (4.5,-0.5) node[]{$x'_{4}$};
    \filldraw[red!40!black] (5.5,-0.5) node[]{$x'_{5}$};
\end{tikzpicture}
...
\begin{split}
    ...
    & f\left(x''_{n_k}\right) \underset{k \to +\infty}{\to} f(x_0) \\
    & \text{По по предположению } \left| f\left(x'_n\right) - f\left(x''_n\right) \right| > \veps_0 \implies \Contradiction \\
\end{split}
}
}
